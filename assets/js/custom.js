...
(function ($) {
  ...
  $(".slider-hero").on("translate.owl.carousel", function () {
    $(".info-header .inner-banner")
      .removeClass("animated fadeOut")
      .css("opacity", "0");
    $(".info-header .top-title-header")
...
function OnSubmitContactUs() {
  ...
  fetch(
    `/submit-contact.php?name=${payload.name}&email=${payload.email}&phone=${payload.phone}&message=${payload.message}`,
    {
      method: "get",
    }
  )
